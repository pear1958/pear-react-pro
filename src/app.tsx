import { history, Link, type RequestConfig, type RunTimeLayoutConfig } from '@umijs/max'
import '@ant-design/v5-patch-for-react-19'
import { LinkOutlined } from '@ant-design/icons'
import { type Settings as LayoutSettings, SettingDrawer } from '@ant-design/pro-components'
import { ANT_PRO_SETTINGS, BG_LAYOUT_IMG_LIST } from 'config/consts'
...
const { baseURL, timeout } = envConfig
...
export async function getInitialState(): Promise<InitialState> {
  ...
  if (![loginPath, '/user/register', '/user/register-result'].includes(history.location.pathname)) {
...
export const layout: RunTimeLayoutConfig = ({ initialState, setInitialState }) => {
  return {
    ...
    bgLayoutImgList: BG_LAYOUT_IMG_LIST,
          ...
          {isDev && (
            <SettingDrawer
              ...
              onSettingChange={settings => {
                ...
                localStorage.setItem(ANT_PRO_SETTINGS, JSON.stringify(settings))
              }}
            />
          )}
        </>
